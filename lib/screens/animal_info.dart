...
class _MyAppState extends State<MyApp> {
  ...
  Future<List<String>> extractData() async {
    ...
    final response =
    await http.Client().get(Uri.parse('https://www.google.com/search?q=margalla+hills+national+park&rlz=1C1ONGR_enPK1024PK1024&oq=MARG&aqs=chrome.0.35i39i355j46i39i175i199j6'
        '9i57j46i67i433j0i67j69i60l3.1750j0j7&sourceid=chrome&ie=UTF-8#lpqa=d,2'));
    ...
    if (response.statusCode == 200) {
      ...
      try {
        ...
        var responseString1 = document
            .getElementsByClassName('yZZ28b')[0]
            .children[0]
            .children[1]
            .children[0]
            .children[0]
